 ...
 *   const client = new OpenApiClient({ apiUrl: 'https://traderai.vip', apiKey: 'xxx' });
...
class OpenApiClient {
   ...
   * @param {string} [options.apiUrl]  开放接口地址（默认: https://traderai.vip）
   * @param {string} options.apiKey  bot_api_key 表中的 api_key
   * @param {number} [options.timeout=15000] 请求超时（毫秒）
   */
  constructor({ apiUrl = 'https://traderai.vip', apiKey, timeout = 15000 }) {
